...
export default function ResearchDetailPage() {
         ...
         try {
            ...
            if (wallet.plan && wallet.plan !== 'none') {
               ...
               if (wallet.plan === 'pro' || wallet.dailyUsed < maxDaily) {
                  ...
                  if (
                     window.confirm(
                        `Gói ${wallet.plan.toUpperCase()} của bạn đã hết lượt đọc hôm nay. Bạn có muốn dùng ${price}đ trong số dư để mua lẻ không?`
                     )
                  ) {
   ...
   return (
      <div className={styles.container}>
         <Link to="/research" className={styles.backBtn}>
            ← Quay lại thư viện
         </Link>
                  ...
                  <div
                     dangerouslySetInnerHTML={{
                        __html:
                           ...
                           '<h2>Mở đầu</h2><p>Phần nội dung mở đầu của bài nghiên cứu đang bị làm mờ...</p>',
                     }}
                     style={{ filter: 'blur(6px)', opacity: 0.4, userSelect: 'none', pointerEvents: 'none' }}
                  />

                  <div
                     className={styles.premiumPlaceholder}
                     style={{ position: 'absolute', top: '10px', left: 0, right: 0, marginTop: 0 }}
                  >
