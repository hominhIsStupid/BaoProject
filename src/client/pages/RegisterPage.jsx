         ...
         <div className={styles.page}>
            <div className={styles.card}>
               ...
               <div className={styles.logoWrap}>
                  <img src="/logo512.png" alt="Rồng Vàng logo" className={styles.logoImg} />
               </div>
               ...
               <div className={styles.formBox}>
                  ...
                  <p className={styles.successText}>
                     Tài khoản của bạn đã được tạo thành công. Bạn có thể đăng nhập để trải nghiệm đọc báo cùng Rồng
                     Vàng.
                  </p>

                  <button className={styles.submitBtn} onClick={() => navigate('/login')} id="btn-go-to-login">
                     Đăng nhập ngay
                  </button>
               </div>
            </div>
