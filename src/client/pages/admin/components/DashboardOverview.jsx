...
export default function DashboardOverview({ stats, articles = [], users = [], onTabChange }) {
   ...
   const chartData = useMemo(() => {
      ...
      const dataSource = metric === 'articles' ? articles : users;
   ...
   }, [timeRange, metric, articles, users]);
   ...
   const metricLabel = metric === 'articles' ? 'Bài viết' : 'Người dùng';
      ...
      <section className={styles.dashboardSection}>
         ...
         <div className={styles.statsGrid}>
            <div className={styles.statBox}>
               ...
               <div className={styles.statText}>
                  ...
                  <div className={styles.statValue}>{stats?.totalArticles || articles.length || 0}</div>
               </div>
            </div>
            ...
            <div className={styles.statBox}>
               ...
               <div className={styles.statText}>
                  ...
                  <div className={styles.statValue}>
                     {stats?.pendingArticles || articles.filter((a) => a.status === 'pending').length || 0}
                  </div>
                  <div className={styles.statSubtext} style={{ color: '#999' }}>
                     Cần xử lý
                  </div>
               </div>
            </div>
            ...
            <div className={styles.statBox}>
               ...
               <div className={styles.statText}>
                  ...
                  <div className={styles.statValue}>{stats?.totalUsers || users.length || 0}</div>
               </div>
            </div>
         </div>
            ...
            <div className={styles.chartBox}>
               <div className={styles.chartHeader} style={{ flexWrap: 'wrap', gap: '1rem' }}>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                     <h2>Tăng trưởng hệ thống</h2>
                     <span>(số lượng {metricLabel.toLowerCase()})</span>
                  </div>
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                     ...
                     >
                        <option value="articles">Số bài viết</option>
                        <option value="users">Số người dùng</option>
                     </select>
                     <select
                        value={timeRange}
            ...
            <div className={styles.chartBox}>
               ...
               <div className={styles.chartPlaceholder} style={{ flexDirection: 'column', background: 'transparent' }}>
                  <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                     {/* Mock pie chart using a simple conic gradient if supported, or just an icon */}
                     <div
                        style={{
                           width: '120px',
                           height: '120px',
                  ...
                  <div className={styles.legendGrid}>
                     ...
                     <div className={styles.legendItem}>
                        ...
                        <span>Đã xuất bản ({statusData.published})</span>
                     </div>
                     <div className={styles.legendItem}>
         ...
         <div className={styles.recentSection}>
            <div className={styles.recentHeader}>
               <h2>Bài viết mới nhận</h2>
               <button className={styles.btnViewAll} onClick={() => onTabChange && onTabChange('articles-manage')}>
                  Xem tất cả
               </button>
            </div>
               ...
               <tbody>
                  {articles.slice(0, 5).map((article) => (
                     <tr key={article.id}>
                        ...
                        <td>{article.authorName || 'Unknown'}</td>
