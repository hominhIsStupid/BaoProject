...
const researchArticles = [
   {
      ...
      summary:
         'Nghiên cứu đánh giá mức độ chính xác của các mô hình LLM trong việc hỗ trợ chẩn đoán lâm sàng và phân tích hồ sơ bệnh án điện tử.',
      content:
         '<h2>1. Mở đầu</h2><p>Trí tuệ nhân tạo đang làm thay đổi bộ mặt của ngành y tế...</p><h2>2. Phương pháp nghiên cứu</h2><p>Chúng tôi đã thử nghiệm GPT-4 và Med-PaLM trên 1000 hồ sơ bệnh án...</p><h2>3. Kết quả</h2><p>Mô hình đạt độ chính xác 85% trong việc đưa ra chẩn đoán sơ bộ...</p>',
   ...
   },
   {
      ...
      summary:
         'Phân tích thực nghiệm về thời gian hoàn thành tác vụ và chất lượng code khi sử dụng các công cụ như GitHub Copilot.',
      content:
         '<h2>1. Giới thiệu</h2><p>Sự ra đời của các công cụ hỗ trợ lập trình bằng AI...</p><h2>2. Thực nghiệm</h2><p>Quan sát 50 lập trình viên chia làm hai nhóm...</p><h2>3. Thảo luận</h2><p>Nhóm sử dụng AI hoàn thành công việc nhanh hơn 30% nhưng tỷ lệ lỗi bảo mật lại cao hơn 5%...</p>',
   ...
   },
   {
      ...
      content:
         '<h2>1. Giới thiệu Học máy lượng tử (QML)</h2><p>QML kết hợp sức mạnh tính toán lượng tử vào các thuật toán học máy...</p><h2>2. Mô hình</h2><p>Sử dụng thuật toán VQC (Variational Quantum Classifier)...</p>',
   ...
   },
   {
      ...
      content:
         '<h2>1. Đặt vấn đề</h2><p>Lớp học truyền thống không thể đáp ứng tốc độ học của từng cá nhân...</p><h2>2. Giải pháp AI</h2><p>Hệ thống tự động phân tích lỗ hổng kiến thức...</p>',
   ...
   },
   {
      ...
      content:
         '<h2>1. Vật liệu Graphene Oxide</h2><p>Với diện tích bề mặt lớn, GO là ứng cử viên sáng giá...</p><h2>2. Thực nghiệm</h2><p>Pha chế dung dịch chứa ion chì (Pb2+)...</p>',
   ...
   },
   {
      ...
      summary:
         'Đề xuất phương pháp lai nghiệm giữa GA và tìm kiếm cấu trúc mạng (NAS) để giảm thiểu chi phí tính toán.',
      content:
         '<h2>1. Neural Architecture Search (NAS)</h2><p>Tìm kiếm cấu trúc tối ưu thường tốn hàng ngàn giờ GPU...</p><h2>2. Thuật toán di truyền</h2><p>Sử dụng cơ chế lai ghép và đột biến...</p>',
